+++
title = "Forensic-Ready Software Design"
type = "home"
+++
...
The role of a software designer starts with using the forensic readiness scenarios to model the systems. Modelling enables exploration of alternative designs, ensuring forensic goals are embedded early and intentionally. However, the objective is to formulate precise requirements for the forensic-ready systems that can be implemented and verified.

## Acknowledgement

The work was supported by the Grant Agency of Masaryk University (GAMU) project “**Forensic Support for Building Trust in Smart Software Ecosystems**”, registration number **MUNI/G/1142/2022**.
