...
*Non-Repudiation* addresses the extent to which any aspect of potential evidence is prevented from repudiation. Thus, there is a significant overlap with the non-repudiation from a security perspective {{< cite "firesmith2003_2" >}}. As noted, non-repudiation for digital evidence is often a synonym for the whole non-disputability {{< cite "richter2010" >}}[pasquale2018" >}}. However, here it is considered as part of it, as the ability of one party to repudiate potential digital evidence arguably does have an impact on disputes.
